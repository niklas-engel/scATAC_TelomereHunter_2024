...
masterdataframe_tanno <- read_csv("masterdataframe_tanno_satpathy.csv")
...
A1 <- ggplot(masterdataframe_tanno, aes(total_reads)) +
  ...
  theme_Publication +
  theme(axis.text.x = element_text(vjust = 1, hjust=0.5, size = 15),  
...
# load the UMAP data
harmony_umap <- readRDS("harmony_umap.rds")
